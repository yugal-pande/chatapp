     ...
     drawer: Drawer(
      child: ListView(
        ...
        children: <Widget>[
            ...
            ListTile(
              onTap: () async{
                showDialog(barrierDismissible: false, context: context, builder: (context){ // Barrier Dismissible False will not close the popup if we click anywhere outside it.
                  return AlertDialog(
      ...
      return StatefulBuilder(
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
            _isLoading == true? Center(child: CircularProgressIndicator(color: Theme.of(context).primaryColor),): TextField(
              onChanged: (val){
                setState(() {
                  groupName = val;
                });
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Theme.of(context).primaryColor), borderRadius: BorderRadius.circular(20)
                )
              ),
            ),
          ],),
          actions: [
            ...
            ElevatedButton(onPressed: () async{
              if(groupName!=""){
                ...
                Navigator.of(context).pop();
                showSnackbar(context, Colors.green, "Group Created Sussessfully");
              }
            },
            style: ElevatedButton.styleFrom(backgroundColor: Theme.of(context).primaryColor),
    ...
    return Container(
      ...
      child:  Column(
        ...
        children: [
          ...
          const Text("You have not joined any group, tap on the add icon to creare one or search from the search icon.",
